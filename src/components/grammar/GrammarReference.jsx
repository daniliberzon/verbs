...
import { Box, Heading, ListItem, SimpleGrid, UnorderedList, Image } from '@chakra-ui/react';
...
<SimpleGrid columns={2} spacing={10} mb={10}>
        <Box h="100%" ml={10} bg="#3EB489" borderRadius="20" align="center">
          <Heading pt={2}>Root (שֹׁרֶשׁ) and Gizra (גִּזְרָה)</Heading>
          <Box w="90%" h="80%" bg="white" mt={4} mb={2} opacity="90%" borderRadius="20">
        ...
        <Box h="100%" mr={10} bg="#3EB489" borderRadius="20" align="center">
